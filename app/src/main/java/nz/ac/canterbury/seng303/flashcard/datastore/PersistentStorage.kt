package nz.ac.canterbury.seng303.flashcard.datastore
...
import nz.ac.canterbury.seng303.flashcard.models.Identifiable
    ...
    override fun edit(identifier: Int, data: T): Flow<Int> {
        return flow {
            ...
            if (index != -1) {
                ...
                emit(OPERATION_FAILURE) // Item not found
            }
        }
    }
